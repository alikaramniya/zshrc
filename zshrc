...
alias mcon="art make:controller"
alias mconr="art make:controller --resource"
alias mmid="art make:middleware"
alias mmod="art make:model"
alias mmodrfs="art make:model --resource --factory --seeder"
alias mmodc="art make:model --controller"
alias mmodr="art make:model --resource"
alias mmoda="art make:model --all"
